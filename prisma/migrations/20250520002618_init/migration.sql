...
INSERT INTO "new_OrderHeader" ("discount", "id", "orderAddressId", "orderStateId", "total", "userId") SELECT "discount", "id", "orderAddressId", "orderStateId", coalesce("total", 0.0) AS "total", "userId" FROM "OrderHeader";
